...
| File | Covers |
| --- | --- |
| `00_GEMINI_NOTEBOOK_ENGINE.md` | The notebook's operating rules, prohibitions, output gate, and six verification tests. |
| `01_REPO_MAP.md` | Directory layout, every route, every service, reading order. |
| `02_GLOSSARY.md` | Terms kept distinct because collapsing them has produced false claims. |
| `10_UI_SURFACES.md` | The two surfaces compared; merchant settings; localization. |
| `11_UI_CHAT_WIDGET.md` | Widget DOM, starter buttons, init guard, Markdown escaping. |
| `12_UI_HOME_BLOCK.md` | Homepage DOM, quiz fields, suggestion chips, accessibility. |
| `13_UI_PRODUCT_CARDS.md` | Card shape, price formatting, the 8-product cap, ordering. |
| `20_UX_STARTER_FLOWS.md` | One catalog, two paths; dispatch order; every failure state. |
