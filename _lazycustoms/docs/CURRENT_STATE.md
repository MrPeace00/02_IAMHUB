...
**Updated through:** September 12, 2026 UTC; v4.1 provider-router and quiz-fact maintenance pass in local working tree plus public catalog/UCP recheck
...
- Engine OI-8 remains action needed: exposed OpenAI, Anthropic if applicable, and Shopify secrets must be rotated and revoked before treating credential-bearing production work as safe.
...
1. Rotate and revoke exposed OpenAI, Anthropic if applicable, and Shopify secrets; update local `.env` and Railway only after rotation.
